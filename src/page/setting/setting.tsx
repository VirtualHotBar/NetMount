    ...
    <div>
      ...
      <Space direction="vertical" size="large" style={{ width: '100%' }}>
          ...
          <Form autoComplete="off" style={{ paddingRight: '0.8rem' }}>
            ...
            <FormItem label={t('autostart')}>
              <Switch
                ...
                /* disabled={osInfo.osType==='Darwin'} */ onChange={async value => {
        ...
        <Card title={t('components')} style={{}} size="small">
          <Link
            onClick={() => {
              shell.open(roConfig.url.rclone)
            }}
          >
            Rclone
          </Link>
          ...
          <Link
            onClick={() => {
              shell.open(roConfig.url.openlist)
            }}
          >
            Openlist
          </Link>
        ...
        <Card title={t('about')} style={{}} size="small">
          <Row>
            <Col flex={'auto'}>
              ...
              <Link
                onClick={() => {
                  openUrlInBrowser(roConfig.url.vhbBlog)
                }}
              >
                VirtualHotBar{' '}
              </Link>
            ...
            <Col flex={'10rem'} style={{ textAlign: 'right' }}>
              <Link
                onClick={() => {
                  openUrlInBrowser(roConfig.url.website)
                }}
              >
                {' '}
                NetMount{' '}
              ...
              <Link
                onClick={() => {
                  openUrlInBrowser(roConfig.url.docs)
                }}
              >
                {' '}
                {t('docs')}{' '}
              ...
              <Link
                onClick={() => {
                  openUrlInBrowser(roConfig.url.docs + '/license')
                }}
              >
                {' '}
                {t('licence')}{' '}
